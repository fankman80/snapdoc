...
public partial class CameraPage : ContentPage
{
    ...
    private async Task InitializeCameraAsync()
    {
        ...
        // OnAppearing kann feuern, bevor der native Handler der CameraView verbunden
        // ist. Dann ist IsAvailable noch false und GetAvailableCameras liefert nichts -
        // die Init brach bisher an dieser Stelle still ab, waehrend das Toolkit die
        // Preview trotzdem selbst mit der Default-Kamera startete.
    ...
    /// <summary>
    /// Reihenfolge: SelectedCamera -> ImageCaptureResolution -> StartCameraPreview.
    /// Zoom und Ratio-Buttons werden erst nach dem Start konfiguriert.
    /// </summary>
    private async Task ApplyCameraAsync(CameraInfo camera)
    {
        try
        {
            ...
            // Falls StartCameraPreview nie zurueckkehrt, sollen Zoom und Buttons
            // trotzdem konfiguriert werden.
        ...
        if (ShowCameraDiagnostics)
            await ShowDiagnosticsAsync(camera);
    }
    ...
    private async void OnSwitchCameraClicked(object sender, EventArgs e)
    {
        ...
        // Nicht per Referenz suchen (IndexOf) - SelectedCamera kann ein anderes
        // CameraInfo-Objekt sein als das in der Liste. Stattdessen die Position wechseln.
