...
public partial class SettingsService : ObservableObject
{
    ...
    [ObservableProperty] private int _photoThumbSize = 150;
    [ObservableProperty] private int _photoThumbQuality = 80;
    [ObservableProperty] private int _photoQuality = 90;
    ...
    [ObservableProperty] private bool _isPhotoOverlayExport = true;
    [ObservableProperty] private bool _isPhotoCompressed = true;
    [ObservableProperty] private int _photoCompressValue = 20;
    ...
    public void SaveSettings()
    {
        var settings = new SettingsModel
        {
            ...
            IsPhotoOverlayExport = IsPhotoOverlayExport,
            IsPhotoCompressed = IsPhotoCompressed,
            PhotoCompressValue = PhotoCompressValue,
            ...
            PhotoThumbQuality = PhotoThumbQuality,
    ...
    public void LoadSettings()
    {
        ...
        try
        {
            ...
            IsPhotoOverlayExport = settings.IsPhotoOverlayExport;
            IsPhotoCompressed = settings.IsPhotoCompressed;
            PhotoCompressValue = settings.PhotoCompressValue;
            ...
            PhotoThumbSize = settings.PhotoThumbSize;
            PhotoThumbQuality = settings.PhotoThumbQuality;
    ...
    public void ResetSettingsToDefaults()
    {
        ...
        IsPhotoOverlayExport = defaultSettings.IsPhotoOverlayExport;
        IsPhotoCompressed = defaultSettings.IsPhotoCompressed;
        PhotoCompressValue = defaultSettings.PhotoCompressValue;
        ...
        PhotoThumbSize = defaultSettings.PhotoThumbSize;
        PhotoThumbQuality = defaultSettings.PhotoThumbQuality;
        PhotoQuality = defaultSettings.PhotoQuality;
